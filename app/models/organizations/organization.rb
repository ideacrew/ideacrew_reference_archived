...
module Organizations
  class Organization
    ...
    has_many    :benefit_sponsorships,
      class_name: "BenefitSponsorships::BenefitSponsorship"
    ...
    def sponsor_benefits_for(profile)
      ...
      if profile.is_benefit_sponsorship_eligible?
        ...
        raise StandardError, "profile #{profile} isn't eligible to sponsor benefits"
    ...
    def generate_hbx_id
      write_attribute(:hbx_id, SecureRandom.uuid) if hbx_id.blank?
    end
