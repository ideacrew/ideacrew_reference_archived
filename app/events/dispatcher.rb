...
# * Listeners registered with `trigger` will be triggered synchronously
# * Listeners registered with `async` will be triggered asynchronously via a Sidekiq Job
#
# Example:
#
#   on Event, trigger: LogEvent, async: TrackEvent
